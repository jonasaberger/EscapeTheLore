        ...
        if pause_game == True:
            ...
            try:
                if world.schanzenshop == None:
                    raise Exception('World.schanzenshop is None!')
                if shopActive == True:
                    if not shopMusic:
                        shopMusic = True
                        mainMusic = False
                        ...
                        musicPlayer.toggleMusic()
                    world.schanzenshop.drawInterface(screen,score_coin,schanzenshop_images,item_images,screen_scroll,player,coin_fx,heal_fx,pizza_fx,brisn_fx,draw_text,scale_img)
            except Exception as error:
                print(error)
            else:
                try:
                    ...
                    if player == None:
                        raise Exception('Player is None!')
                    shopMusic = False
                    if not mainMusic and player.isRocker == False: 
                        mainMusic = True
                        musicPlayer.toggleMusic()
                        musicPlayer.loadMusic("Game/assets/audio/background_music.wav")
                        musicPlayer.toggleMusic()
                    elif not mainMusic and player.isRocker == True: 
                        mainMusic = True
                        musicPlayer.toggleMusic()
